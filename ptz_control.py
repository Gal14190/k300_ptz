...
class ptzControl(object):
    ...
    def move_abspantilt(self, pan, tilt, velocity, zoom=0):
    ...
    def get_position(self):
        return self.ptz.GetStatus({'ProfileToken': self.media_profile.token}).Position.PanTilt

    def get_zoom(self):
        return self.ptz.GetStatus({'ProfileToken': self.media_profile.token}).Position.Zoom.x
